...
<?php while(have_posts()) : the_post(); ?>
	...
	<article id="bio" class="bio">
		...
		<div class="bio-left">
			...
			<?php if(get_field('bio_experience')) : ?>
			...
			<?php if(get_field('bio_studies') || get_field('bio_courses') || get_field('bio_others')) : ?>
				<div class="bio-left-right">

					<?php if(get_field('bio_studies')) : ?>
						<section id="bio-studies">
							<h2 class="bio-title"><?php _e('Studies', 'gp3'); ?></h2>
							<ul>
								<?php while(has_sub_field('bio_studies')) : ?>
									<li class="bio-career">
										<p class="bio-career-name"><?php the_sub_field('bio_career_name'); ?></p>
										<p class="bio-career-center"><?php if(get_sub_field('bio_career_center_url')) : ?><a href="<?php the_sub_field('bio_career_center_url'); ?>" target="_blank"><?php endif; the_sub_field('bio_career_center'); if(get_sub_field('bio_career_center_url')) : ?></a><?php endif; ?>, <span class="bio-career-ended"><?php the_sub_field('bio_career_ended'); ?></span></p>
									</li>
								<?php endwhile; ?>
							</ul>
						</section>
					...
					<?php if(get_field('bio_courses')) : ?>
						<section id="bio-courses">
							<h2 class="bio-title"><?php _e('Courses', 'gp3'); ?></h2>
							<ul>
								<?php while(has_sub_field('bio_courses')) : ?>
									<li class="bio-course">
										<p class="bio-course-name"><?php the_sub_field('bio_course_name'); ?></p>
										<p class="bio-course-center"><?php if(get_sub_field('bio_course_center_url')) : ?><a href="<?php the_sub_field('bio_course_center_url'); ?>" target="_blank"><?php endif; the_sub_field('bio_course_center'); if(get_sub_field('bio_course_center_url')) : ?></a><?php endif; ?>, <span class="course-lenght"><?php the_sub_field('bio_course_lenght'); ?></span>. <span class="bio-course-date"><?php the_sub_field('bio_course_date'); ?></span></p>
									</li>
								<?php endwhile; ?>
							</ul>
						</section>
					...
					<?php if(get_field('bio_others')) : ?>
						<section id="bio-others">
							<h2 class="bio-title"><?php _e('Others', 'gp3'); ?></h2>
							<ul>
								<?php while(has_sub_field('bio_others')) : ?>
									<li class="bio-other">
										<p class="bio-other-name"><?php the_sub_field('bio_other_name'); ?></p>
										<p class="bio-other-description"><?php the_sub_field('bio_other_description'); ?></p>
									</li>
								<?php endwhile; ?>
							</ul>
						</section>
